# java conde conventions coding standards
...
[Java Code Conventions](Java%20Oracle%20Coding%20Standards%20codeconventions-150003%202020-08-15.pdf)
...
**`*NOTE: These do not feel natural when it comes to Java, they feel like they would fit better with another language.`**
...
* [SpotBugs][1] (earlier [Findbugs][2]) for finding existing bugs.  VERY GOOD!
* [PMD][3] for finding patterns that can lead to bugs (e.g. unused variables)
* [Checkstyle][4] to enforce coding standards and conventions (e.g. whitespace, Javadoc)
* [Error Prone][5] hooks right into your application's compile step
