...
*/
var aa="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)},ba="undefined"!=typeof window&&window===this?this:"undefined"!=typeof global&&null!=global?global:this;
...
;function db(){return k("gapi.iframes.getContext")()}
function eb(){return k("gapi.iframes.SAME_ORIGIN_IFRAMES_FILTER")}
;function fb(a){try{a.register("msg-hovercard-subscription",gb,eb())}catch(b){}}
function gb(a){if(a){a=!!a.isSubscribed;var b=document.getElementById("yt-subscribe-card");a?ab(b,"subscribe"):$a(b,"subscribe");a?$a(b,"subscribed"):ab(b,"subscribed")}}
...
c;b.position=e;b.visibility=d}a={width:a.width,height:a.height};db().ready(a,null,void 0);a=eb();db().addOnOpenerHandler(fb,null,a)}
var S=R;S=void 0===S?{}:S;"function"==fa(S)&&(S={callback:S});R=S;var hb;(hb=R.gapiHintOverride)||(hb="GAPI_HINT_OVERRIDE"in N?N.GAPI_HINT_OVERRIDE:void 0);
if(hb){var ib;var T=document.location.href;if(-1!=T.indexOf("?")){T=(T||"").split("#")[0];var jb=T.split("?",2),W=1<jb.length?jb[1]:jb[0];"?"==W.charAt(0)&&(W=W.substr(1));for(var kb=W.split("&"),X={},lb=0,mb=kb.length;lb<mb;lb++){var Y=kb[lb].split("=");if(1==Y.length&&Y[0]||2==Y.length)try{var Z=decodeURIComponent((Y[0]||"").replace(/\+/g," ")),nb=decodeURIComponent((Y[1]||"").replace(/\+/g," "));Z in X?"array"==fa(X[Z])?ja(X[Z],nb):X[Z]=[X[Z],nb]:X[Z]=nb}catch(a){if("q"!=Y[0]){var ob=Error("Error decoding URL component");
ob.params={key:Y[0],value:Y[1]};var pb=k("yt.logging.errors.log");if(pb)pb(ob,void 0,void 0,void 0,void 0);else{var qb,rb=[];qb="ERRORS"in N?N.ERRORS:rb;qb.push([ob,void 0,void 0,void 0,void 0]);cb("ERRORS",qb)}}}}ib=X}else ib={};var sb=ib.gapi_jsh;sb&&na(R,{_c:{jsl:{h:sb}}})}Va("gapi.iframes:gapi.iframes.style.common",R);}).call(this);
